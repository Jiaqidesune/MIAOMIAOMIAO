...
Texture::Texture(GLuint target, GLint internalformat, GLenum format, GLenum type,
...
void Texture::Filter(GLuint minFilter, GLuint magFilter)
{
    glBindTexture(m_Target, m_Object);
...
void Texture::Wrap(GLuint s, GLuint t, GLuint r)
{
    glBindTexture(m_Target, m_Object);
...
void Texture::SubImage2D(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, const void* data)
{
    glBindTexture(m_Target, m_Object);
